...
class BufferBase(ABC):
    ...
    def sparse_approximation(self):
        ...
        #print(edges, unary_cost, pairwise_cost, label_cost)
        #WX, fixing Buffer has wrong number of dimensions (expected 2, got 1)
#        import pdb; pdb.set_trace()
       ...
       # plt.show()
        # print("family:", len(np.unique(labels)), "No. points:", len(approx_ys), "Labels_diff:", max(labels)-min(labels) )

...
def opt_acquisition(X_known, gpr, elements, acq_func='EI', xi=0.01, n_iter_max=1000, n_random=1000, step_size=0.005, max_ratio=0.8):
    ...
    for i in range(n_random):
        temp = random_comp(elements, max_ratio)
